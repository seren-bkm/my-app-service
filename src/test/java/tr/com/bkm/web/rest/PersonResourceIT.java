...
import tr.com.bkm.repository.PersonRepository;
import tr.com.bkm.service.dto.PersonDTO;
import tr.com.bkm.service.mapper.PersonMapper;
...
class PersonResourceIT {
    ...
    public static Person createEntity(EntityManager em) {
        Person person = new Person().name(DEFAULT_NAME).surname(DEFAULT_SURNAME).age(DEFAULT_AGE);
        return person;
    }
    ...
    public static Person createUpdatedEntity(EntityManager em) {
        Person person = new Person().name(UPDATED_NAME).surname(UPDATED_SURNAME).age(UPDATED_AGE);
        return person;
    }
    ...
    void putNewPerson() throws Exception {
        ...
        updatedPerson.name(UPDATED_NAME).surname(UPDATED_SURNAME).age(UPDATED_AGE);
    ...
    void fullUpdatePersonWithPatch() throws Exception {
        ...
        partialUpdatedPerson.name(UPDATED_NAME).surname(UPDATED_SURNAME).age(UPDATED_AGE);
